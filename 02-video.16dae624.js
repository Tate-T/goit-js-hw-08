...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector("iframe"),o=new Vimeo.Player(r),n=function(e){localStorage.setItem("videoplayer-current-time",e.seconds)};o.on("timeupdate",(0,e.default)(n,1e3));const u=localStorage.getItem("videoplayer-current-time");u?o.setCurrentTime(u):o.setCurrentTime(0);
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.16dae624.js.map